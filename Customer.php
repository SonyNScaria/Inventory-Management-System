...
<head>
	...
	{ 
			window.location.href = "Customer_Edit.php?name=" + a;
     
	}
	function myJavascriptFunctionDelete() 
	{ 
			window.location.href = "Customer_Delete.php?name=" + a;
    ...
    <div class="navbar-header">
		...
		<a class="navbar-brand" href="http://www.thomsonfoods.com/" target="_blank"><b><i><?php echo $row_admin['NAME'] ?></i></b></a>
			...
			<div class="collapse navbar-collapse navHeaderCollapse">
				...
				<li><a href="#" data-toggle="modal" data-target="#myModal"><b>Add Customer</b></a></li>
				<li><a href="#" onclick="myJavascriptFunctionEdit();"><b>Edit Customer</b></a></li>
				<li><a href="#" onclick="myJavascriptFunctionDelete();"><b>Delete Customer</b></a></li>
				<li><a target="_blank" href="Export_Excel_Customer.php"><b>Export to Excel</b></a></li>
				<li><a target="_blank" href="Export_PDF_Customer.php"><b>Export to PDF</b></a></li>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title"><b>Add Customers#</b></h4>
        </div>
        <div class="modal-body">
          <form class="col-md-12 center-block" method="POST" action="Customer_Add.php">
					<div class="form-group">
						<input type="text" class="form-control" name="Customers" placeholder=" Enter number of Customers you wish to add: " onkeypress='return event.charCode >= 49 && event.charCode <= 57'>
					</div>
					<div class="form-group">
...
<script>  
 $(document).ready(function(){  
      $('#create_excel').click(function(){  
           var excel_data = $('#customer_table').html();  
           var page = "Export_Excel_Customer.php?data=" + excel_data;  
