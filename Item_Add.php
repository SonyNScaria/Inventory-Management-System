...
{
	header('Location: Item.php?status=505'); 
}
...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container">
	...
	<div class="container">
  <h2></h2>    
<form class="col-md-12 center-block" action="Item_Add_Process.php" method="POST">  
<input type="hidden" class="form-control" name="no" value="<?php echo $counter; ?>">
  <table class="table table-condensed">
    ...
    <tbody>
		...
		<td><input type="text" class="form-control" name="<?php echo "description".$x; ?>"></td>
        <td><input type="text" class="form-control" name="<?php echo "unitweight".$x; ?>" onkeypress='return event.charCode >= 46 && event.charCode <= 57'></td>
		<td><input type="text" class="form-control" name="<?php echo "unitprice".$x; ?>" onkeypress='return event.charCode >= 46 && event.charCode <= 57'></td>
		</tr>
	</tbody>
	<?php
	}
