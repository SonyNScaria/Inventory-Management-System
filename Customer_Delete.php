...
<nav class="navbar navbar-inverse navbar-static-top">
  <div class="container">
	...
	<div class="container">
  <h2></h2>    
<form class="col-md-12 center-block" action="Customer_Delete_Process.php" method="POST">  
	...
	while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) 
{
	...
	?>	
     <tbody>
		...
		<td><textarea class="form-control" name="<?php echo "address".$row['ID']; ?>" value="" readonly><?php echo $row['ADDRESS'] ?></textarea></td>
		<td><textarea class="form-control" name="<?php echo "shipping_address".$row['ID']; ?>" value="" readonly><?php echo $row['SHIPPING_ADDRESS'] ?></textarea></td>
        <td><input type="text" class="form-control" name="<?php echo "phone".$row['ID']; ?>" value="<?php echo $row['PHONE'] ?>" readonly></td>
		<td><input type="text" class="form-control" name="<?php echo "email".$row['ID']; ?>" value="<?php echo $row['EMAIL'] ?>" readonly></td>
		<td><input type="text" class="form-control" name="<?php echo "outstanding".$row['ID']; ?>" value="<?php echo "$".$row['OUTSTANDING'] ?>" readonly></td>
...
else
{
	...
	{ 
		...
		<tr>
		<td><input type="text" class="form-control" name="<?php echo "name".$row['ID']; ?>" value="<?php echo $row['NAME'] ?>" readonly></td>
		<td><input type="text" class="form-control" name="<?php echo "address".$row['ID']; ?>" value="<?php echo $row['ADDRESS'] ?>" readonly></td>
        <td><input type="text" class="form-control" name="<?php echo "phone".$row['ID']; ?>" value="<?php echo $row['PHONE'] ?>" readonly></td>
		<td><input type="text" class="form-control" name="<?php echo "email".$row['ID']; ?>" value="<?php echo $row['EMAIL'] ?>" readonly></td>
		<td><input type="text" class="form-control" name="<?php echo "outstanding".$row['ID']; ?>" value="<?php echo "$".$row['OUTSTANDING'] ?>" readonly></td>
		<td><input type="hidden" class="form-control" name="<?php echo $row['ID']; ?>" value="<?php echo $row['ID'] ?>"></td>
